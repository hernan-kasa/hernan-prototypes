...
import { feeTypes, FEE_CATEGORIES, feeCategoryMap } from '../data/feeTypes';
  ...
  return (
    <Box>
      <Alert severity="info" sx={{ mb: 3 }}>
        Fees are managed via the CMB pipeline. This is a read-only reference of the {feeTypes.length} fee types available from the NextPax Supply API.
      </Alert>
      ...
      >
        ...
        <InputBase
          placeholder="Search fees by name or code..."
          value={searchQuery}
